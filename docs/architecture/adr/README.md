...
| [ADR-0004](./0004-agy-box-installation-paths.md) | Ag-Box Sandbox Installation Paths | **Accepted** | Prerequisite validation, active socket verification, and OS-specific path routing for agy-box. |
